...
class SamsaraBotService {
  ...
  async sendVehicleDefLevelAlert(
    ...
    try {
      ...
      console.error("Error in sendVehicleDefLevelAlert:", error);
      return "Error processing DEF level alert. Please check logs for details.";
    }
  }
  ...
  async sendHarshBrakeAlert(
    ...
    try {
      ...
      console.error("Error in sendHarshBrakeAlert:", error);
      return "Error processing harsh brake alert. Please check logs for details.";
    }
  }
  ...
  async sendCrashAlert(
    ...
    try {
      ...
      try {
        ...
        console.error("Failed to get location data for crash alert:", error);
      }
      ...
      console.error("Error in sendCrashAlert:", error);
      return "Error processing crash alert. Please check logs for details.";
    }
  }
  ...
  async sendDistractedDrivingAlert(
    ...
    try {
      ...
      console.error("Error in sendDistractedDrivingAlert:", error);
      return "Error processing distracted driving alert. Please check logs for details.";
    }
  }
  ...
  async sendHarshAccelerationAlert(
    ...
    try {
      ...
      console.error("Error in sendHarshAccelerationAlert:", error);
      return "Error processing harsh acceleration alert. Please check logs for details.";
    }
  }
  ...
  async sendSevereSpeedingAlert(
    ...
    try {
      ...
      return (
        ...
        `\n\n${escapeMarkdown(recommendation)}` +
        `\n[🔗View Incident](${webhookData.data.incidentUrl})`
      );
    } catch (error) {
      console.error("Error in sendSevereSpeedingAlert:", error);
      return "Error processing severe speeding alert. Please check logs for details.";
    }
  }
  ...
  async sendHarshTurnAlert(
    ...
    try {
      ...
      console.error("Error in sendHarshTurnAlert:", error);
      return "Error processing harsh turn alert. Please check logs for details.";
    }
  }
}
